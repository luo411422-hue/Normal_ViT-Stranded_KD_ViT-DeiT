...
class ResNet(nn.Module):
    def __init__(self, dataset='cifar10', depth=18, num_classes=10, bottleneck=False):
        ...
        if self.dataset.startswith('cifar'):
        ...
        elif self.dataset in {'imagenet', 'cassava'}:
            blocks = {
                18: BasicBlock,
                34: BasicBlock,
                50: Bottleneck,
            ...
            assert layers[depth], (
                'invalid detph for ResNet (depth should be one of 18, 34, 50, '
                '101, 152, and 200)'
            )
            ...
            raise ValueError(
                "Unsupported dataset. Expected one of 'cifar10', 'cifar100', "
                "'imagenet', or 'cassava'."
            )
    ...
    def forward(self, x, return_features=False, feature_layer='layer2'):
        features = {}
...
if __name__ == '__main__':
    net = ResNet34(dataset='cassava', num_classes=5)
