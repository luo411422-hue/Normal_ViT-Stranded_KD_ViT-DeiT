...
class DistillMixin: # adds distillation token and mlp head to ViT
    def forward(self, img, distill_token = None):#知识蒸馏的混合类 ，输入图像和知识蒸馏的token
...
class DistillWrapper(Module): # wrapper for distillation 
    def __init__(
        self,
        *,
        teacher,
